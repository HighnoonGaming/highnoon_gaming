...
import nick from '@/assets/team/nick.jpg'
    ...
    socials: [
      {
        ...
        color: '#E4405F',
        link: 'https://instagram.com/nicholasroach',
      },
      {
        name: 'linkedin',
        icon: 'mdi:linkedin',
        color: '#0A66C2',
        link: 'https://linkedin.com/in/nicholasroach',
      },
      {
        name: 'behance',
        icon: 'mdi:behance',
        color: '#1769FF',
        link: 'https://behance.net/nicholasroach',
      },
    ],
    contact: 'nicholas@ourteam.com',
  },
  {
    id: '1476',
    img: rick,
    ...
    socials: [
      {
        ...
        icon: 'qlementine-icons:instagram-16',
        color: '#E4405F',
        link: 'https://instagram.com/ricardoknight',
      },
      {
        name: 'linkedin',
        icon: 'mdi:linkedin',
        color: '#0A66C2',
        link: 'https://linkedin.com/in/ricardoknight',
      },
      {
        name: 'twitter',
        icon: 'pajamas:twitter',
        color: '#000000',
        link: 'https://twitter.com/ricardoknight',
      },
    ],
    contact: 'ricardo@ourteam.com',
  },
  {
    id: '1477',
    img: mark,
    ...
    socials: [
      {
        ...
        icon: 'mdi:github',
        color: '#181717',
        link: 'https://github.com/corb0140',
      },
      {
        name: 'linkedin',
        icon: 'mdi:linkedin',
        color: '#0A66C2',
        link: 'https://www.linkedin.com/in/mark-corbin-18771b9b/',
      },
      {
        name: 'twitter',
        icon: 'pajamas:twitter',
